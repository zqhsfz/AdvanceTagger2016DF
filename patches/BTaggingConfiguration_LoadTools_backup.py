...
# special setup using tracks association found by k-means clustering
...
#            addTool('GbbNNTag', ToolSvc, 'BTagTrackToJetAssociatorKmeans', JetCollection, Verbose = BTaggingFlags.OutputLevel < 3)
  ...
  if 'MVb' in TaggerList:
    ConfInstance.addTool('MVbTag', ToolSvc, 'BTagTrackToJetAssociatorKmeans', JetCollection, Verbose = BTaggingFlags.OutputLevel < 3)
  if 'MVbFlip' in TaggerList:
    ConfInstance.addTool('MVbFlipTag', ToolSvc, 'BTagTrackToJetAssociatorKmeans', JetCollection, Verbose = BTaggingFlags.OutputLevel < 3)
  if 'MV1c' in TaggerList:
...
#    addTool('MV2Tag', ToolSvc, 'BTagTrackToJetAssociatorKmeans', JetCollection, Verbose = BTaggingFlags.OutputLevel < 3)
  if 'MV2c00' in TaggerList:
    ConfInstance.addTool('MV2c00Tag', ToolSvc, 'BTagTrackToJetAssociatorKmeans', JetCollection, Verbose = BTaggingFlags.OutputLevel < 3)
  if 'MV2c00Flip' in TaggerList:
    ConfInstance.addTool('MV2c00FlipTag', ToolSvc, 'BTagTrackToJetAssociatorKmeans', JetCollection, Verbose = BTaggingFlags.OutputLevel < 3)
  if 'MV2c10' in TaggerList:
    ConfInstance.addTool('MV2c10Tag', ToolSvc, 'BTagTrackToJetAssociatorKmeans', JetCollection, Verbose = BTaggingFlags.OutputLevel < 3)
  if 'MV2c10Flip' in TaggerList:
    ConfInstance.addTool('MV2c10FlipTag', ToolSvc, 'BTagTrackToJetAssociatorKmeans', JetCollection, Verbose = BTaggingFlags.OutputLevel < 3)
  if 'MV2c20' in TaggerList:
    ConfInstance.addTool('MV2c20Tag', ToolSvc, 'BTagTrackToJetAssociatorKmeans', JetCollection, Verbose = BTaggingFlags.OutputLevel < 3)
  if 'MV2c20Flip' in TaggerList:
    ConfInstance.addTool('MV2c20FlipTag', ToolSvc, 'BTagTrackToJetAssociatorKmeans', JetCollection, Verbose = BTaggingFlags.OutputLevel < 3)
  if 'MV2c100' in TaggerList:
    ConfInstance.addTool('MV2c100Tag', ToolSvc, 'BTagTrackToJetAssociatorKmeans', JetCollection, Verbose = BTaggingFlags.OutputLevel < 3)
  if 'MV2c100Flip' in TaggerList:
    ConfInstance.addTool('MV2c100FlipTag', ToolSvc, 'BTagTrackToJetAssociatorKmeans', JetCollection, Verbose = BTaggingFlags.OutputLevel < 3)
  if 'MV2cl100' in TaggerList:
    ConfInstance.addTool('MV2cl100Tag', ToolSvc, 'BTagTrackToJetAssociatorKmeans', JetCollection, Verbose = BTaggingFlags.OutputLevel < 3)
  if 'MV2cl100Flip' in TaggerList:
    ConfInstance.addTool('MV2cl100FlipTag', ToolSvc, 'BTagTrackToJetAssociatorKmeans', JetCollection, Verbose = BTaggingFlags.OutputLevel < 3)
  if 'MV2m' in TaggerList:
    ConfInstance.addTool('MV2mTag', ToolSvc, 'BTagTrackToJetAssociatorKmeans', JetCollection, Verbose = BTaggingFlags.OutputLevel < 3)
  if 'MV2mFlip' in TaggerList:
    ConfInstance.addTool('MV2mFlipTag', ToolSvc, 'BTagTrackToJetAssociatorKmeans', JetCollection, Verbose = BTaggingFlags.OutputLevel < 3)
  if 'MV2c10hp' in TaggerList:
    ConfInstance.addTool('MV2c10hpTag', ToolSvc, 'BTagTrackToJetAssociatorKmeans', JetCollection, Verbose = BTaggingFlags.OutputLevel < 3)
  if 'MV2c10hpFlip' in TaggerList:
    ConfInstance.addTool('MV2c10hpFlipTag', ToolSvc, 'BTagTrackToJetAssociatorKmeans', JetCollection, Verbose = BTaggingFlags.OutputLevel < 3)
  if 'JetVertexCharge' in TaggerList:
