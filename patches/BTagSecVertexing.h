...
namespace Analysis
{
  ...
  class BTagSecVertexing : public AthAlgTool, virtual public IBTagSecVertexing
  {
    ...
    StatusCode fillJFVariables(xAOD::Jet&, xAOD::BTagging*, xAOD::VertexContainer*, xAOD::BTagVertexContainer*, const Trk::VxJetFitterVertexInfo*, const xAOD::TrackParticleContainer*, std::string);
